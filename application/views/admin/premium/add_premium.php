<div class="conatiner">
    <form action="<?php echo base_url() . 'admin/premium/create_premium'; ?>" method="POST" id="myForm" name="myForm" class="form-container mx-auto  shadow-container" style="width:80%" enctype="multipart/form-data">
        <h3 class="mb-3 text-center">Add premium Items</h3>
        <div class="row">
            <div class="col-md-6">
                <div class="form-group">
                    <label for="name">Premium Name</label>
                    <input type="text" class="form-control my-2 
                    <?php echo (form_error('name') != "") ? 'is-invalid' : ''; ?>" name="name" id="name" placeholder="Enter premium name" value="<?php echo set_value('name'); ?>">
            ...
            <div class="col-md-6">
                ...
                <div class="form-group">
                    <label for="img">Premium Image</label>
