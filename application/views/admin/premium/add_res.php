<div class="conatiner">
    <form action="<?php echo base_url() . 'admin/premium/create_premium'; ?>" method="POST" class="form-container mx-auto  shadow-container" id="myForm" style="width:90%" enctype="multipart/form-data">
        <h3 class="mb-3 p-2 text-center mb-3">Add New Sales Details</h3>
        <div class="row">
            <div class="col-md-6">
                <div class="form-group">
                    <label class="control-label">Sales Name</label>
                    <input type="text" name="res_name" id="rname" class="form-control
                    <?php echo (form_error('res_name') != "") ? 'is-invalid' : ''; ?>" placeholder="Add Sales Name" value="<?php echo set_value('res_name'); ?>">
        ...
        <div class="form-actions">
            ...
            <a href="<?php echo base_url() . 'admin/premium/index' ?>" class="btn btn-secondary">Cancel</a>
        </div>
    </form>
</div>
<script>
