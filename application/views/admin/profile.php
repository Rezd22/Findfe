...
<div class="row">
    <div class="col-md-6">
        <div class="wrapper mt-sm-5">
            ...
            <?php endif ?>
            <?php $loggedadmin = $this->session->userdata('admin'); ?>
            <form action="<?php echo base_url() . 'admin/profile/edit/' . $loggedadmin['admin_id'] ?>" method="POST" enctype="multipart/form-data">
                ...
                <div class="py-2">
                    ...
                    <div class="py-3 pb-4 border-bottom">
                        ...
                        <a href="<?php echo base_url() . 'admin/home' ?>" class="btn border button">Cancel</a>
                    </div>
                </div>
            </form>
        </div>
    ...
    <div class="col-md-6">
        <div class="wrapper mt-sm-5">
            ...
            <?php endif ?>
            <?php $loggedadmin = $this->session->userdata('admin'); ?>
            <form action="<?php echo base_url() . 'admin/profile/editPassword/' . $loggedadmin['admin_id'] ?>" method="POST">
