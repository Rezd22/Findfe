<div class="conatiner">
    <form action="<?php echo base_url() . 'deletestock/deletestock'; ?>" method="POST" id="myForm" name="myForm" class="form-container mx-auto  shadow-container" style="width:80%" enctype="multipart/form-data">
        <h3 class="mb-3 text-center">Delete Stock Items</h3>
