...
<div id="slides" class="carousel slide carousel-cus" data-ride="carousel">
    ...
    <div class="carousel-inner">
        ...
        <div class="carousel-item">
            <img src="<?php echo base_url() . 'public/front/img/bg4.jpg'; ?>" alt="Spaghetti">
...
<div class="container-fluid padding">
    <div class="row text-center welcome">
        ...
        <hr>
        <div class="col-12">
            <p class="lead">Cara termudah untuk stocking biji kopi . Sistem Findfe menyediakan pencarian mitra
                dengan waktu singkat dan pemesanan biji kopi . Jadi jangan menunggu dan mulai memesan sekarang juga!</p>
        </div>
    </div>
</div>
<div class="container-fluid padding">
    <div class="row text-center padding">
        <div class="col-xs-12 col-sm-6 col-md-4">
            ...
            <h3>Pilih Mitra</h3>
            <p>Hal pertama yang dapat Anda lakukan adalah memilih dari mitra kami dengan mudah!</p>
        </div>
        <div class="col-xs-12 col-sm-6 col-md-4">
            ...
            <h3>Pilih Biji Kopi </h3>
            <p>Kami membantu Anda dengan biji kopi dari berbagai mitra pengiriman online!</p>
        </div>
        <div class="col-sm-12 col-md-4">
            ...
            <p>Bagaimanapun, biji kopi akan dikirim atau Anda dapat mengambilnya sesuai pilihan Anda!</p>
        </div>
    </div>
    <hr class="my-4">
</div>
<div class="container-fluid padding">
    <div class="row welcome text-center welcome">
        <div class="col-12">
            <h1 class="display-4">Biji Kopi </h1>
        </div>
        <hr>
    </div>
</div>
