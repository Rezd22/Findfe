...
<div class="container">
    ...
    <div class="table-responsive-sm">
        <table class="table table-striped table-hover">
                    ...
                    foreach ($cartItems as $item) { ?>
                        <tr>
                            <td>
                                ...
                                <img class="" width="70" src="<?php echo base_url() . 'public/uploads/premium/' . $image; ?>">
                            </td>
            ...
            <tfoot>
                <tr>
                    <td><a href="<?php echo base_url() . 'mitra/premium/list' ?>" class="btn btn-sm btn-warning"><i class="fas fa-angle-left"></i> Continue Ordering</a></td>
                    <td colspan="3"></td>
                    <?php if ($this->cart->total_items() > 0) { ?>
                        <td class="text-left">Grand Total: <b><?php echo 'Rp' . $this->cart->total(); ?></b></td>
                        <td><a href="<?php echo base_url() . 'mitra/checkout'; ?>" class="btn btn-sm btn-success btn-block">Checkout <i class="fas fa-angle-right"></i></a></td>
                    <?php } ?>
                </tr>
            </tfoot>
        </table>
