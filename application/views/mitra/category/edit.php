<div class="container shadow-container">
    <h2 class="p-2 text-center">Edit Mitra Category "<?php echo $cat['c_name']; ?>"</h2>
    <form action="<?php echo base_url() . 'mitra/category/edit/' . $cat['c_id']; ?>" class="container" method="POST" id="myForm">
        ...
        <a class="btn btn-secondary" href="<?php echo base_url() . 'mitra/category/index'; ?>">Back</a>
    </form>
</div>
<script>
