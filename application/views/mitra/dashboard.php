    ...
    <div class="row">
        ...
        <!-- <div class="col-md-6 mt-3">
            <div class="row">
                ...
                <div class="col-md-12">
                    <a href="<?php $id = 1;
                                echo base_url() . 'mitra/home/generate_pdf/' . $id; ?>" class="btn btn-success mt-3">Download Report</a>
                </div>
            </div>
        </div>
        <div class="col-md-6 mt-3">
            <div class="row">
                ...
                <div class="col-md-12">
                    <table class="table table-striped table-responsive table-hover">
                        ...
                        <tbody id="myTable">
                            <?php if (!empty($kopiReport)) { ?>
                                <?php foreach ($kopiReport as $report) { ?>
                                    <tr>
