...
<body>
    <div class="container my-3" style="border: 2px outset green;">
        ...
        <footer class="text-center">
            ...
            <p>Untuk syarat &ketentuan Silakan kunjungi www.unej.id</p>
        </footer>
    </div>
    <div class="container text-center">
        <a href="<?php echo base_url() . 'mitra/premium/list' ?>" class="btn btn-sm btn-warning p-2"><i class="fas fa-angle-left"></i>
            Back to Orders</a>
    </div>
