...
<body>
    <div class="conatiner">
        <h1 class="text-center mt-3">Mitra Panel</h1>
        ...
        ?>
        <form action="<?php echo base_url() . 'mitra/login/authenticate'; ?>" name="loginform" id="loginform" method="POST" class="form-container mx-auto">
