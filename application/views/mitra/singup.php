...
<body>
    <div class="wrapper container">
        ...
        <h1 class="text-center my-3">Buat Akun Mitra</h1>
        <form action="<?php echo base_url() . 'mitra/singup/create_user'; ?>" method="POST" name="myForm" id="myForm" class="form-container mx-auto shadow-container">
            <div class="row">
                <div class="col-md-6">
