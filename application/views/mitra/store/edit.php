<div class="conatiner">
    <form action="<?php echo base_url() . 'mitra/store/edit/' . $store['r_id']; ?>" method="POST" class="form-container mx-auto  shadow-container" style="width:90%" enctype="multipart/form-data">
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <?php echo (form_error('res_name') != "") ? 'is-invalid' : ''; ?>" placeholder="Add Mitra name" value="<?php echo set_value('res_name', $store['name']); ?>">
            ...
            <div class="col-md-12">
                <div class="form-group has-danger">
                    ...
                    <?php if ($store['img'] != '' && file_exists('./public/uploads/toko/thumb/' . $store['img'])) { ?>
                        <img class="mt-1" src="<?php echo base_url() . 'public/uploads/toko/thumb/' . $store['img']; ?>">
                    <?php } else { ?>
        ...
        <div class="form-actions">
            ...
            <a href="<?php echo base_url() . 'mitra/store/index' ?>" class="btn btn-secondary">Cancel</a>
        </div>
    </form>
</div>
<script>
