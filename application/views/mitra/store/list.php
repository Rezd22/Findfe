                    ...
                    <?php if (!empty($stores)) { ?>
                        <?php foreach ($stores as $store) { ?>
                            <tr>
                                ...
                                <td>
                                    <a href="<?php echo base_url() . 'mitra/store/edit/' . $store['r_id'] ?>" class="btn btn-info mb-1"><i class="fas fa-edit mr-1"></i>Edit</a>
...
<script type="text/javascript">
    function deleteStore(id) {
        if (confirm("Are you sure you want to delete store?")) {
            window.location.href = '<?php echo base_url() . 'mitra/store/delete/'; ?>' + id;
        }
    }
