<div class="conatiner">
    ...
    <form action="<?php echo base_url() . 'mitra/user/edit/' . $user['u_id']; ?>" method="POST" class="form-container mx-auto shadow-container" id="myForm" style="width:80%">
        ...
        <a href="<?php echo base_url() . 'mitra/user/index'; ?>" class="btn btn-secondary">Back</a>
    </form>
</div>
<script>
