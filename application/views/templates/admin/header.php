    ...
    <div id="sidebar" class="tm-sidebar-left uk-background-default">
        <center>
            <div class="user">
                ...
                <div id="name" class="uk-text-truncate"></div>
        ...
        <ul class="uk-nav uk-nav-default">
            ...
            ?>
                ...
                <li <?php if ($menu == "geo") {
                    ?> class="uk-active" <?php
                                        } ?>><a href="<?= base_url('administrator/geo') ?>"><span data-uk-icon="icon:  world" class="uk-margin-small-right"></span>PETA PEMETAAN</a></li>
            <?php
            }
